 ...
 */
typedef struct hexaworld_raylib_app_t hexaworld_raylib_app_t;
 ...
 * @return hexaworld_raylib_app_t* a pointer to the application data instance, or NULL if it could not be allocated
 */
